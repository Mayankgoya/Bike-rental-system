...
public class LoginServelet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            User u = dao.getUserByUserEmail(userEmail, userPassword);
           
            
            if (u == null)
            {
                // Login error
               //  out.println("invaild details !!! try again");
                Message msg = new Message("Invaid details ! try again " , "error","alert-danger");
